                        ...
                        for (int i = 0; i < Table->Column_Count; i++)
                        {
                            if(Table->Configs[i].COL_Type == 1){
                                ...
                                if(*err != '\0'){
                                    ...
                                    fwrite(0, sizeof(int), 1, Table->LoadedTable);
                                }
                            }
                            else
                            {
                                fwrite(Instructions[i+1], sizeof(int), sizeof(char) * 64, Table->LoadedTable);
                            }

                            int Pointer = ftell(Table->LoadedTable);
                            fseek(Table->LoadedTable, Table->DataStart, SEEK_END);
                            int entries;
                            ...
                            fseek(Table->LoadedTable, Pointer, SEEK_SET);
